...
@Client.on_message(
    command([".توقف", f"stop@{BOT_USERNAME}", "end", f"end@{BOT_USERNAME}", "vstop"])
    & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command([".ايقاف مؤقتا", f"pause@{BOT_USERNAME}", "vpause"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command([".استئتاف", f"resume@{BOT_USERNAME}", "vresume"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command([".تنزيل", f"volume@{BOT_USERNAME}", "vol"]) & other_filters
)
@authorized_users_only
